<template>
    <div class="row">
        <div class="mb-3 col-xs-12 col-md-12 col-lg-12">
            <button class="btn btn-action btn-light w-100" type="button" @click="onOpenSettingsProfile()">
        ...
        <div class="mb-3 col-xs-12 col-md-12 col-lg-12">
            <button class="btn btn-action btn-light" type="button" @click="onOpenSettingsSecurity()">
        ...
        <div class="mb-3 col-xs-12 col-md-12 col-lg-12">
            <button class="btn btn-action btn-light" type="button" @click="onOpenSettingsActivities()">
